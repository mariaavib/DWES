...
class CAmbitos {
    ...
    // Vista principal que envía al modelo
    ...
    // Vista que procesa el formulario y valida los datos antes de enviarlos al modelo
    ...
    // Vista que muestra el minijuego seleccionado
